  ...
  actions: {
    ...
    async QueryProposals(
      ...
      try {
        ...
        while (all && value.pagination && value.pagination.nextKey != null) {
          let next_values = (await queryClient.queryProposals({ ...query, 'pagination.key': value.pagination.nextKey }))
            .data
    ...
    async QueryVotes(
      ...
      try {
        ...
        while (all && value.pagination && value.pagination.nextKey != null) {
          let next_values = (
            await queryClient.queryVotes(key.proposal_id, { ...query, 'pagination.key': value.pagination.nextKey })
          ).data
          value = mergeResults(value, next_values)
        }
    ...
    async QueryDeposits(
      ...
      try {
        ...
        while (all && value.pagination && value.pagination.nextKey != null) {
          let next_values = (
            await queryClient.queryDeposits(key.proposal_id, { ...query, 'pagination.key': value.pagination.nextKey })
          ).data
          value = mergeResults(value, next_values)
        }
