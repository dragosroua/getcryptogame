...
const getDefaultState = () => {
  return {
    ...
    _Structure: {
      ...
      EventBurnDebtToken: getStructure(EventBurnDebtToken.fromPartial({})),
      ...
      EventCreateFighter: getStructure(EventCreateFighter.fromPartial({})),
      EventCancelFighter: getStructure(EventCancelFighter.fromPartial({})),
      EventFulfillFight: getStructure(EventFulfillFight.fromPartial({})),
      ...
      Fighter: getStructure(Fighter.fromPartial({})),
      ...
      PaymentProcessor: getStructure(PaymentProcessor.fromPartial({})),
      Params: getStructure(Params.fromPartial({})),
      PaymentInfo: getStructure(PaymentInfo.fromPartial({})),
      ...
      RedeemInfo: getStructure(RedeemInfo.fromPartial({})),
...
export default {
  ...
  getters: {
    getListTradesByCreator:
      (state) =>
      (params = { params: {} }) => {
        if (!params.query) {
          params.query = null
        }
        return state.ListTradesByCreator[JSON.stringify(params)] ?? {}
      },
    getFight:
      (state) =>
      (params = { params: {} }) => {
        ...
        return state.Fight[JSON.stringify(params)] ?? {}
      },
    getRedeemInfo:
      (state) =>
      (params = { params: {} }) => {
        ...
        return state.RedeemInfo[JSON.stringify(params)] ?? {}
      },
    getRedeemInfoAll:
      (state) =>
      (params = { params: {} }) => {
        ...
        return state.RedeemInfoAll[JSON.stringify(params)] ?? {}
      },
    getPaymentInfo:
      (state) =>
      (params = { params: {} }) => {
        ...
        return state.PaymentInfo[JSON.stringify(params)] ?? {}
      },
    getPaymentInfoAll:
      (state) =>
      (params = { params: {} }) => {
        ...
        return state.PaymentInfoAll[JSON.stringify(params)] ?? {}
      },
  ...
  actions: {
    ...
    async QueryListTradesByCreator(
      ...
      try {
        ...
        while (all && value.pagination && value.pagination.nextKey != null) {
          let next_values = (
            await queryClient.queryListTradesByCreator(key.creator, {
              ...query,
        ...
        commit('QUERY', { query: 'ListTradesByCreator', key: { params: { ...key }, query }, value })
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryListTradesByCreator',
            payload: { options: { all }, params: { ...key }, query },
          })
        return getters['getListTradesByCreator']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new SpVuexError(
          'QueryClient:QueryListTradesByCreator',
    ...
    async QueryFight(
      ...
      try {
        const queryClient = await initQueryClient(rootGetters)
        let value = (await queryClient.queryFight(query)).data
        while (all && value.pagination && value.pagination.nextKey != null) {
          let next_values = (await queryClient.queryFight({ ...query, 'pagination.key': value.pagination.nextKey }))
            .data
          value = mergeResults(value, next_values)
        }
        commit('QUERY', { query: 'Fight', key: { params: { ...key }, query }, value })
        if (subscribe)
          commit('SUBSCRIBE', { action: 'QueryFight', payload: { options: { all }, params: { ...key }, query } })
        return getters['getFight']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new SpVuexError('QueryClient:QueryFight', 'API Node Unavailable. Could not perform query: ' + e.message)
      }
    },
    async QueryRedeemInfo(
      { commit, rootGetters, getters },
      { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null },
    ) {
      try {
        ...
        if (subscribe)
          commit('SUBSCRIBE', { action: 'QueryRedeemInfo', payload: { options: { all }, params: { ...key }, query } })
        return getters['getRedeemInfo']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new SpVuexError(
          'QueryClient:QueryRedeemInfo',
          'API Node Unavailable. Could not perform query: ' + e.message,
        )
      }
    },
    async QueryRedeemInfoAll(
      { commit, rootGetters, getters },
      { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null },
    ) {
      try {
        ...
        while (all && value.pagination && value.pagination.nextKey != null) {
          let next_values = (
            await queryClient.queryRedeemInfoAll({ ...query, 'pagination.key': value.pagination.nextKey })
          ).data
          value = mergeResults(value, next_values)
        }
        commit('QUERY', { query: 'RedeemInfoAll', key: { params: { ...key }, query }, value })
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryRedeemInfoAll',
            payload: { options: { all }, params: { ...key }, query },
          })
        return getters['getRedeemInfoAll']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new SpVuexError(
          'QueryClient:QueryRedeemInfoAll',
          'API Node Unavailable. Could not perform query: ' + e.message,
        )
      }
    },
    async QueryPaymentInfo(
      ...
      try {
        ...
        if (subscribe)
          commit('SUBSCRIBE', { action: 'QueryPaymentInfo', payload: { options: { all }, params: { ...key }, query } })
        return getters['getPaymentInfo']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new SpVuexError(
          'QueryClient:QueryPaymentInfo',
          'API Node Unavailable. Could not perform query: ' + e.message,
        )
      }
    },
    async QueryPaymentInfoAll(
      { commit, rootGetters, getters },
      { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null },
    ) {
      try {
        ...
        while (all && value.pagination && value.pagination.nextKey != null) {
          let next_values = (
            await queryClient.queryPaymentInfoAll({ ...query, 'pagination.key': value.pagination.nextKey })
          ).data
          value = mergeResults(value, next_values)
        }
        commit('QUERY', { query: 'PaymentInfoAll', key: { params: { ...key }, query }, value })
        if (subscribe)
          commit('SUBSCRIBE', {
            action: 'QueryPaymentInfoAll',
            payload: { options: { all }, params: { ...key }, query },
          })
        return getters['getPaymentInfoAll']({ params: { ...key }, query }) ?? {}
      } catch (e) {
        throw new SpVuexError(
          'QueryClient:QueryPaymentInfoAll',
          'API Node Unavailable. Could not perform query: ' + e.message,
        )
      }
    },
    async QueryUsernameByAddress(
      { commit, rootGetters, getters },
      { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null },
    ) {
      try {
        ...
        throw new SpVuexError(
          'QueryClient:QueryUsernameByAddress',
          'API Node Unavailable. Could not perform query: ' + e.message,
        )
      }
    },
    async QueryAddressByUsername(
      { commit, rootGetters, getters },
      { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null },
    ) {
      try {
        ...
        throw new SpVuexError(
          'QueryClient:QueryAddressByUsername',
          'API Node Unavailable. Could not perform query: ' + e.message,
        )
      }
    },
    ...
    async QueryListItemByOwner(
      ...
      try {
        ...
        while (all && value.pagination && value.pagination.nextKey != null) {
          let next_values = (
            await queryClient.queryListItemByOwner(key.owner, { ...query, 'pagination.key': value.pagination.nextKey })
          ).data
          value = mergeResults(value, next_values)
        }
        ...
        throw new SpVuexError(
          'QueryClient:QueryListItemByOwner',
          'API Node Unavailable. Could not perform query: ' + e.message,
        )
      }
    },
    async QueryGoogleInAppPurchaseOrder(
      { commit, rootGetters, getters },
      { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null },
    ) {
      try {
        ...
        throw new SpVuexError(
          'QueryClient:QueryGoogleInAppPurchaseOrder',
          'API Node Unavailable. Could not perform query: ' + e.message,
        )
      }
    },
    async QueryListExecutionsByItem(
      { commit, rootGetters, getters },
      { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null },
    ) {
      try {
        ...
        while (all && value.pagination && value.pagination.nextKey != null) {
          let next_values = (
            await queryClient.queryListExecutionsByItem(key.CookbookID, key.ItemID, {
              ...query,
              'pagination.key': value.pagination.nextKey,
            })
          ).data
        ...
        throw new SpVuexError(
          'QueryClient:QueryListExecutionsByItem',
          'API Node Unavailable. Could not perform query: ' + e.message,
        )
      }
    },
    async QueryListExecutionsByRecipe(
      { commit, rootGetters, getters },
      { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null },
    ) {
      try {
        ...
        while (all && value.pagination && value.pagination.nextKey != null) {
          let next_values = (
            await queryClient.queryListExecutionsByRecipe(key.CookbookID, key.RecipeID, {
              ...query,
              'pagination.key': value.pagination.nextKey,
            })
          ).data
        ...
        throw new SpVuexError(
          'QueryClient:QueryListExecutionsByRecipe',
          'API Node Unavailable. Could not perform query: ' + e.message,
        )
      }
    },
    async QueryExecution(
      ...
      try {
        ...
        throw new SpVuexError(
          'QueryClient:QueryExecution',
          'API Node Unavailable. Could not perform query: ' + e.message,
        )
      }
    },
    async QueryListRecipesByCookbook(
      { commit, rootGetters, getters },
      { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null },
    ) {
      try {
        ...
        while (all && value.pagination && value.pagination.nextKey != null) {
          let next_values = (
            await queryClient.queryListRecipesByCookbook(key.CookbookID, {
              ...query,
              'pagination.key': value.pagination.nextKey,
            })
          ).data
        ...
        throw new SpVuexError(
          'QueryClient:QueryListRecipesByCookbook',
          'API Node Unavailable. Could not perform query: ' + e.message,
        )
      }
    },
    ...
    async QueryListCookbooksByCreator(
      { commit, rootGetters, getters },
      { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null },
    ) {
      try {
        ...
        while (all && value.pagination && value.pagination.nextKey != null) {
          let next_values = (
            await queryClient.queryListCookbooksByCreator(key.creator, {
              ...query,
              'pagination.key': value.pagination.nextKey,
            })
          ).data
        ...
        throw new SpVuexError(
          'QueryClient:QueryListCookbooksByCreator',
          'API Node Unavailable. Could not perform query: ' + e.message,
        )
      }
    },
    ...
    async sendMsgTransferCookbook({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            'TxClient:MsgTransferCookbook:Init',
    ...
    async sendMsgUpdateCookbook({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            'TxClient:MsgUpdateCookbook:Init',
            'Could not initialize signing client. Wallet is required.',
          )
        } else {
    ...
    async sendMsgEnlistForArena({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        const txClient = await initTxClient(rootGetters)
        const msg = await txClient.msgEnlistForArena(value)
        const result = await txClient.signAndBroadcast([msg], { fee: { amount: fee, gas: '9000000' }, memo })
        return result
      } catch (e) {
        if (e == MissingWalletError) {
          throw new SpVuexError(
            'TxClient:MsgEnlistForArena:Init',
            'Could not initialize signing client. Wallet is required.',
          )
        } else {
          throw new SpVuexError('TxClient:MsgEnlistForArena:Send', 'Could not broadcast Tx: ' + e.message)
        }
      }
    },
    ...
    async sendMsgUpdateAccount({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            'TxClient:MsgUpdateAccount:Init',
            'Could not initialize signing client. Wallet is required.',
          )
        } else {
    ...
    async sendMsgBurnDebtToken({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        const txClient = await initTxClient(rootGetters)
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            'TxClient:MsgBurnDebtToken:Init',
            'Could not initialize signing client. Wallet is required.',
          )
        } else {
          throw new SpVuexError('TxClient:MsgBurnDebtToken:Send', 'Could not broadcast Tx: ' + e.message)
        }
      }
    },
    async sendMsgCreateCookbook({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            'TxClient:MsgCreateCookbook:Init',
            'Could not initialize signing client. Wallet is required.',
          )
        } else {
    ...
    async sendMsgCreateAccount({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            'TxClient:MsgCreateAccount:Init',
            'Could not initialize signing client. Wallet is required.',
          )
        } else {
    ...
    async sendMsgSetItemString({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            'TxClient:MsgSetItemString:Init',
            'Could not initialize signing client. Wallet is required.',
          )
        } else {
    ...
    async sendMsgExecuteRecipe({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            'TxClient:MsgExecuteRecipe:Init',
            'Could not initialize signing client. Wallet is required.',
          )
        } else {
    ...
    async sendMsgGoogleInAppPurchaseGetCoins({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            'TxClient:MsgGoogleInAppPurchaseGetCoins:Init',
            'Could not initialize signing client. Wallet is required.',
          )
        } else {
    ...
    async sendMsgCompleteExecutionEarly({ rootGetters }, { value, fee = [], memo = '' }) {
      try {
        ...
        if (e == MissingWalletError) {
          throw new SpVuexError(
            'TxClient:MsgCompleteExecutionEarly:Init',
            'Could not initialize signing client. Wallet is required.',
          )
        } else {
    ...
    async MsgEnlistForArena({ rootGetters }, { value }) {
      try {
        const txClient = await initTxClient(rootGetters)
        const msg = await txClient.msgEnlistForArena(value)
        return msg
        ...
        if (e == MissingWalletError) {
          ...
          throw new SpVuexError('TxClient:MsgEnlistForArena:Create', 'Could not create message: ' + e.message)
        }
      }
    },
    ...
    async MsgBurnDebtToken({ rootGetters }, { value }) {
      try {
        const txClient = await initTxClient(rootGetters)
        const msg = await txClient.msgBurnDebtToken(value)
        return msg
    ...
    async MsgGoogleInAppPurchaseGetCoins({ rootGetters }, { value }) {
      try {
        ...
        if (e == MissingWalletError) {
          ...
          throw new SpVuexError(
            'TxClient:MsgGoogleInAppPurchaseGetCoins:Create',
